<div class="row">
    <div class="col-md-6">
        <p class="text-left">Alunos</p>
    </div>
    <div class="col-md-6">
        <p class="text-right"><a href="index.php?class=Aluno&function=create"><button type='button' class='btn btn-primary'><span class='glyphicon glyphicon-plus'></button></a></p>
    </div>
</div>
                            ...
                            <div class='modal-dialog' role='document'>
                                <div class='modal-content'>
                                    <div class='modal-header'>
                                        ...
                                        <h4 class='modal-title' id='deleteModalLabel'>Aluno</h4>
                                    </div>
                                    <div class='modal-body'>Tem certeza que deseja excluir o aluno?</div>
                                    <div class='modal-footer'>
                                        <button type='button' class='btn btn-default' data-dismiss='modal'>Voltar</button>
                                        <a class='btn btn-danger' href='index.php?class=Aluno&function=delete&id=$object->id' role='button'>Excluir</a>
                                    </div>
                                </div>
                            </div>
                        </div>
